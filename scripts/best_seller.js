...
var best_div = [{"brand":"Serge Lutens","name":"La Fille De Berlin Eau De Parfum Spray 50ml/1.6oz","discount":"37","price":"7401.50","image":"https://a.cdnsbn.com/images/products/250/15728689106.jpg","deal":"Editor","category":"Perfume"},
...
var best_seller = document.getElementById("best_sell");

function showProducts3(data) {
    var best_seller_products = data;

    best_seller.innerHTML = "";

    data.forEach(function (object){
        add_best_seller_Products(object);
    });
}

showProducts3(best_div);

function add_best_seller_Products(object) {
    
    let div = document.createElement("div");
    div.setAttribute("class", "productBox");
    
    let div_four = document.createElement('div');
    div_four.innerHTML=` <div><i class="fa fa-heart-o fa-2x" style="font-size:24px; float: right; margin-right: 20px; margin-top: 10px; color:#623381;"></i></div>`;
    ...
    div.append(div_four, pro_image, pro_name, brk, prod_description, brk,brk,brk,pro_discount,brk,

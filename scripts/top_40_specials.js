...
var top_specials = [{"brand":"Serge Lutens","name":"La Fille De Berlin Eau De Parfum Spray 50ml/1.6oz","discount":"37","price":"7401.50","image":"https://a.cdnsbn.com/images/products/250/15728689106.jpg","deal":"Editor","category":"Perfume"},
...
var top_div = document.getElementById("top_40_specials");
...
function showProducts2(data) {
    ...
    data.forEach(function (object){
        add_Top_Products(object);
    });
}

showProducts2(top_specials);

function add_Top_Products(object) {
    
    let div = document.createElement("div");
    div.setAttribute("class", "productBox");
    
    let div_three = document.createElement('div');
    div_three.innerHTML=` <div><i class="fa fa-heart-o fa-2x" style="font-size:24px; float: right; margin-right: 20px; margin-top: 10px; color:#623381;"></i></div>`;
    ...
    div.append(div_three, pro_image, pro_name, brk, prod_description, brk,brk,brk,pro_discount,brk,

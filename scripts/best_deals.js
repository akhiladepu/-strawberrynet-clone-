var best_Prods = [{"brand":"Bvlgari","name":"Petits Et Mamans Eau De Toilette Spray 100ml/3.3oz","discount":"2","price":"4441.00","image":"https://a.cdnsbn.com/images/products/250/02144435006.jpg","deal":"None","category":"Perfume"},
...
var data_div_1 = document.getElementById("best_product_deals");

function showProducts1(data) {
    var bestProd_data = data;

    data_div_1.innerHTML = "";
...
showProducts1(best_Prods);

function addProducts(object) {
    
    let div = document.createElement("div");
    div.setAttribute("id", "bestProducts");
    
    let div_two = document.createElement('div');
    div_two.innerHTML=` <div><i class="fa fa-heart-o fa-2x" style="font-size:24px; float: right; margin-right: 20px; margin-top: 10px; color:#623381;"></i></div>`;

    let pro_image = document.createElement("img");
    pro_image.src = object.image;
    
    let dealsBox = document.createElement('div');
    dealsBox.setAttribute('id','bestdealsbox');
    dealsBox.innerHTML = `<div id="bestdealsboxtxt">BEST DEALS</div>`;
